...
globalkeys = gears.table.join(
   ...
   --
   awful.key({ modkey }, "0",
      function () awesome.spawn("amixer set Master 100%,100%", false) end,
      {description = "amixer stereo"}),
   awful.key({ modkey }, "'",
      function () awesome.spawn("amixer set Master 100%,0%", false) end,
      {description = "amixer left"}),
   awful.key({ modkey }, "¿",
      function () awesome.spawn("amixer set Master 0%,100%", false) end,
 ...
 --
   ...
   awful.key({ modkey }, "b",
      function ()
         ...
         if myscreen.mywiboy.visible and myscreen.mywibox.visible then
            myscreen.mywiboy.visible = false
         elseif (not myscreen.mywiboy.visible) and (not myscreen.mywibox.visible) then
            myscreen.mywiboy.visible = true
