...
(custom-set-variables
 ...
 '(package-selected-packages
   '(markless lsp-haskell ccls flycheck-clj-kondo flycheck-golangci-lint godoctor lsp-mode helm-company cpp-auto-include auctex auctex-latexmk tex-fold tex latex pdf-tools ormolu hindent python-black google-c-style irony arduino-cli-mode auto-minor-mode arduino-mode ob-go aggressive-indent rust-mode lice ag projectile vterm systemd typescript-mode kaolin-themes darcula-theme cyberpunk-theme abyss-theme sly-macrostep sly git-timemachine csound-mode gitignore-templates yasnippet-snippets dimmer diredful toml-mode org-mind-map smartparens focus helm-dash tidal magit-todos redshank gorepl-mode gotest dockerfile-mode shader-mode glsl-mode lua-mode string-inflection phi-search ivy-erlang-complete lfe-mode helm-clojuredocs browse-at-remote which-key gnu-elpa-keyring-update spinner ace-window helm-gtags minimap forge csharp-mode spacemacs-theme spaceline gitignore-mode imenu-list ggtags peep-dired cmake-mode cpputils-cmake flycheck-rebar3 erlang editorconfig multiple-cursors company-math latex-preview-pane elixir-mode sclang-extensions robe cider web-beautify flycheck go-guru go-mode elpy paredit jinja2-mode yaml-mode ansible magit neotree auto-complete company clojure-mode yasnippet markdown-mode dummyparens extempore-mode chicken-scheme))
